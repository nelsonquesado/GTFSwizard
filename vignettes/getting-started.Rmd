...
fields, identifiers, sequences, dates, and times. With no path in an
interactive R session, it opens a file browser.

```{r, eval=FALSE}
gtfs <- read_gtfs("path/to/feed.zip")
gtfs <- read_gtfs() # choose a zip file interactively
```
